...
import com.example.moroapplication.Activity_Home;
import com.example.moroapplication.R;
import com.example.moroapplication.activity_rental_details;

import java.util.List;

public class Home_rsvSr_adapter extends RecyclerView.Adapter<Home_rsvSr_adapter.HomeViewHolder> {
    private Context mContext;
    private List<Home> mListHome;

    public Home_rsvSr_adapter(Context mContext, List<Home> mListHome) {
    ...
    @NonNull
    @Override
    public Home_rsvSr_adapter.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
